            ...
            <div class="login-box">
                <div class="login-snip"> <input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1" class="tab">Login</label> <input id="tab-2" type="radio" name="tab" class="sign-up"><label for="tab-2" class="tab">Sign Up</label>
                    ...
                    <div class="login-space">
                        ...
                        <div class="login">
                            <div class="group"> <label for="user" class="label"><?php echo $msg1; ?></label></div>
                            ...
                            <div class="group"> <input type="submit" class="button" name="Signin" value="Sign In"> </div>
                            <div class="hr"></div>
                    ...
                    <form name="form" action="action.php?pid=1" method="post">
                        <div class="sign-up-form">
                            <div class="group"> <label for="user" class="label"><?php echo $msg2;?></label></div> 
                            ...
                            <div class="group"> <label for="pass" class="label">Repeat Password</label> <input id="pass" name="cpass" type="password" class="input" data-type="password" placeholder="Repeat your password"> </div>
                            <div  id='p'></div>
                            <div class="group"> <label for="pass" class="label">Email Address</label> <input id="pass" name="email" type="text" class="input" placeholder="Enter your email address"> </div>
...
<script>
    ...
    function validate()
    {
       ...
       var cpass=form.cpass.value;
        ...
        if(pass!=cpass) // Name
        {
            document.getElementById('p').innerHTML="Password not matched!!";
            if(flag==1)
            form.cpass.focus();
            flag=0;
        }

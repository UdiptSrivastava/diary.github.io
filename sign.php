	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" name="form" action="action.php?pid=1" method="post">

					<span class="login100-form-title p-b-43">
						Login to continue
					</span>
					<div style="text-align: center;color: #F77C7C "><?php echo $msg1; ?></div>
					...
					<div class="flex-sb-m w-full p-t-3 p-b-32">
						...
						<div>
							<a href="forget_pass.php" class="txt1">
								Forgot Password?
							</a>
						</div>
					</div>

...
<p align="center" style="font-size: large;color: green" ><?php echo $msg; ?></p>
    <form name="form" method="post" action="action.php?pid=5" enctype="multipart/form-data">
        ...
        <input type="text" class="form-control" value="<?php echo $rs[5]; ?>" readonly id="mdate" name="dob">
       </div>
    ...
    <div><?php if($rs[9]=="Male") { echo "Male"; } else { echo "Female";} ?> </div>    
        ...
        <div class="input-group">
            <div class="custom-file">
                <input type="file" class="custom-file-input" name="eimg">
